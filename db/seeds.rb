...
a1 = Album.create(cover: "<%= image_tag "my-beautiful-dark-twisted-fantasy.jpg" %>", title: "My Beautiful Dark Twisted Fantasy", artist: "Kanye West")
...
a3 = Album.create(cover: "<%= image_tag "21.png" %>", title: "21", artist: "Adele")
...
a4 = Album.create(cover: "<%= image_tag "channel-orange.jpg" %>", title: "Channel Orange", artist: "Frank Ocean")
...
a5 = Album.create(cover: "<%= image_tag "good-kid-maad-city.jpg" %>", title: "Good Kid, M.A.A.D City", artist: "Kendrick Lamar")
...
a7 = Album.create(cover: "<%= image_tag "the-2020-experience.png" %>", title: "The 20/20 Experience", artist: "Justin Timberlake")
...
a8 = Album.create(cover: "<%= image_tag "Goo-Goo-Dolls-Greatest-Hits-Vol-420071.jpg" %>", title: "Greatest Hits", artist: "Goo Goo Dolls")
