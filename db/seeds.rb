...
a1 = Album.create(cover: "https://raw.githubusercontent.com/ruthno/bass-music-rails/master/app/assets/images/my_beautiful_dark_twisted_fantasy.jpg", title: "My Beautiful Dark Twisted Fantasy", artist: "Kanye West")
...
a2 = Album.create(cover: "https://raw.githubusercontent.com/ruthno/bass-music-rails/master/app/assets/images/beyonce.png", title: "Beyonce", artist: "Beyonce")
...
a3 = Album.create(cover: "https://raw.githubusercontent.com/ruthno/bass-music-rails/master/app/assets/images/twentyone.png", title: "21", artist: "Adele")
...
a4 = Album.create(cover: "https://raw.githubusercontent.com/ruthno/bass-music-rails/master/app/assets/images/channel_orange.jpg", title: "Channel Orange", artist: "Frank Ocean")
...
a5 = Album.create(cover: "https://raw.githubusercontent.com/ruthno/bass-music-rails/master/app/assets/images/good_kid_maad_city.jpg", title: "Good Kid, M.A.A.D City", artist: "Kendrick Lamar")
...
a6 = Album.create(cover: "https://raw.githubusercontent.com/ruthno/bass-music-rails/master/app/assets/images/ram.jpg", title: "Random Access Memories", artist: "Daft Punk")
...
a7 = Album.create(cover: "https://raw.githubusercontent.com/ruthno/bass-music-rails/master/app/assets/images/the_2020_experience.png", title: "The 20/20 Experience", artist: "Justin Timberlake")
...
a8 = Album.create(cover: "https://raw.githubusercontent.com/ruthno/bass-music-rails/master/app/assets/images/Goo_Goo_Dolls_Greatest_Hits_Vol.jpg", title: "Greatest Hits", artist: "Goo Goo Dolls")
Track.create(name: "Let Love In", minutes: 8, album_id: a8.id)
Track.create(name: "Dizzy", minutes: 5, album_id: a8.id)
Track.create(name: "Here is Gone", minutes: 6, album_id: a8.id)
Track.create(name: "Slide", minutes: 8, album_id: a8.id)
Track.create(name: "Name", minutes: 7, album_id: a8.id)
Track.create(name: "Before it's too late", minutes: 8, album_id: a8.id)
Track.create(name: "Broadway", minutes: 6, album_id: a8.id)
Track.create(name: "Better Days", minutes: 9, album_id: a8.id)
Track.create(name: "Big Machine", minutes: 7, album_id: a8.id)
Track.create(name: "Black Balloon", minutes: 8, album_id: a8.id)
